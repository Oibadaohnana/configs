...
#
# Served over HTTPS at https://rezepte.buggly.de -- nginx terminates TLS with
# the shared *.buggly.de cert and proxies to the loopback port below, on the
...
in {
  ...
  # borrows it.
  services.nginx.virtualHosts."rezepte.buggly.de" = {
